<template>
  <svg x="1120" y="650" width="60" height="30" class="sc-idjmjb ewNxLJ" type="premier">
    <rect
      fill="transparent"
      stroke="none"
      transform="rotate(0 42 80)"
      class="sc-AqAhp cNleWn"
      width="160"
      height="84"
      id="seat-15488613"
    />
    <g transform="rotate(0, 80, 42)" class="sc-fHlXLc bXVYGC" height="84" width="160">
      <svg
        width="100%"
        height="100%"
        viewBox="0 0 154 84"
